...
headless Chromium either way, it doesn't read screen pixels or inject OS-level
input.
...
Each account (e.g. YouTube Hindi) gets its own persistent Chromium profile
...
Each command opens a real, visible Chromium window. Log in fully (including
