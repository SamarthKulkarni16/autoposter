...
if __name__ == "__main__":
    print(
        "setup_profile.py is OBSOLETE: config.ACCOUNTS now points every "
        ...
        "create anymore. If an account actually needs re-logging-in, do it by "
        "hand in that Chrome profile on the VM's real desktop session (RDP), "
